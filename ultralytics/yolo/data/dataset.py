...
class YOLODataset(BaseDataset):
    ...
    def build_transforms(self, hyp=None):
        ...
        if self.augment:
            ...
            transforms = v8_transforms(self, self.imgsz, hyp, cube=self.cube)
        else:
            transforms = Compose([LetterBox(new_shape=(self.imgsz, self.imgsz), scaleup=False, cube=self.cube)])
            # transforms =Compose([])
        transforms.append(
    ...
    def collate_fn(batch):
        ...
        for i, k in enumerate(keys):
            ...
            if k in ['masks', 'keypoints', 'bboxes', 'bboxes_t1', 'bboxes_t2', 'bboxes_t3', 'cls']:
