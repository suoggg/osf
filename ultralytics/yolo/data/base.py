...
class BaseDataset(Dataset):
    ...
    def load_image(self, i):
        ...
        if self.cube:
            ...
            id = os.path.basename(f).split(".jpg")[0]
            # t6 = int(id)
            # t1 = max((t6 - 10), 1)
            # t2 = max((t6 - 8), 1)
            # t3 = max((t6 - 6), 1)
            ...
            t1_str = str(t1).zfill(len(id))
            t2_str = str(t2).zfill(len(id))
            # t3 = str(t3).zfill(len(id))
            # t4 = str(t4).zfill(len(id))
            # t5 = str(t5).zfill(len(id))
            t1_path = os.path.join(img_path, t1_str + ".jpg")
            t2_path = os.path.join(img_path, t2_str + ".jpg")
