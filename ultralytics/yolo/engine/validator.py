...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        bar = tqdm(self.dataloader, desc, n_batches, bar_format=TQDM_BAR_FORMAT, ncols=80, ascii=True)
        ...
        for batch_i, batch in enumerate(bar):
            ...
            with dt[3]:
                # global save_name
                # save_name = batch['im_file'][0].split('/')[-2] + '+' + batch['im_file'][0].split('/')[-1]
                preds = self.postprocess(preds, self.training)
