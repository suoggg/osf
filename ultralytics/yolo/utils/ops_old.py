...
def non_max_suppression(
    ...
    if cube:
        ...
        #error(这里有bug未解决，多目标检测时nms得到多个结果，如何在多帧内进行cat？)
        outputs = []
        ...
        outputs = nms(prediction[:, :],conf_thres,iou_thres,classes,agnostic,multi_label,labels,max_det,nc,max_time_img,max_nms,max_wh,before=False)
