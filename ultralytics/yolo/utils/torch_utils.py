...
def vit_flops(h, w, r, dim):
    flops = 2 * h * w * (h // r) * (w // r) * dim
    return flops

def swin_flops(h, w, r, dim):
    flops = 2 * h * w * 7 * 7 * dim
    return flops
...
def get_flops(model, imgsz=640):
    ...
    try:
        ...
        # stage1 = vit_flops(80, 80, 1, 32) * 1 / 1E9 * 2
        # stage2 = vit_flops(40, 40, 1, 64) * 1 / 1E9 * 2
        # stage3 = vit_flops(20, 20, 1, 160) * 1 / 1E9 * 2
        # stage4 = vit_flops(10, 10, 1, 256) * 1 / 1E9 * 2
        # flops = flops + stage1 + stage2 + stage3 + stage4
        # return flops
        
        flops = flops * imgsz[0] / stride * imgsz[1] / stride
        stage1 = swin_flops(80, 80, 1, 32) * 1 / 1E9 * 2
        stage2 = swin_flops(40, 40, 1, 64) * 1 / 1E9 * 2
        stage3 = swin_flops(20, 20, 1, 160) * 1 / 1E9 * 2
        stage4 = swin_flops(10, 10, 1, 256) * 1 / 1E9 * 2
        flops = flops + stage1 + stage2 + stage3 + stage4
        return flops
