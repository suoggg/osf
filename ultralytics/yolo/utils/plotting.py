...
def plot_images(images,
    ...
    images = images[:bs]  # slice first

    if ch > 3:
        # If images have more than 3 channels (e.g., cube mode with 9 channels),
        # take the last 3 channels (current frame t) for plotting.
        images = images[:, -3:, :, :]
    
    # bs, _, h, w = images.shape  # already sliced and updated
